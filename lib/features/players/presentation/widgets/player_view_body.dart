...
class _PlayerViewBodyState extends State<PlayerViewBody> {
  late List<PlayerGameStatsEntity> playerGameStatsList;
  ...
  Widget build(BuildContext context) {
    ...
    final PlayerEntity player = widget.playerDetailsArgs.player;
        ...
        builder: (context, state) {
          ...
          return CustomScrollView(
            ...
            slivers: [
              ...
              SliverToBoxAdapter(child: PlayerWinLossBar(player: player)),

              SliverToBoxAdapter(child: Gap(8.h)),

              // 3. Stats Grid
              SliverToBoxAdapter(
                child: PlayerStatsGridView(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (playerGameStatsList.length > 5) {
                          AllPreviousGamesForPlayerBottomSheet.show(
                            context,
